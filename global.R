...
WR_to_TD <- function(x, system = c("MnNCKFMASHT", "CMASH", "NASH", "KASH", "NCMASH", "NCFMASH", "NFMASH", "KFMASH", "MnKFMASH", "MnNCKFMASH", "MnCKFMASH", "MnNCKFMASHT", "MnCKFMASHT"), H = NULL, O = NULL, round = 4, cmt = NULL){
